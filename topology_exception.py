...
def repair_topology_exception(submission_path, precision, image_id, n_class, point, 
    ...
    df.to_csv(submission_path,
              index=False)
    print('It took %i seconds to repair the submission' + str(time.time() - start_time))

if __name__ == '__main__':
#    repair_topology_exception('subm/1.csv',
#                              precision=6,
#                              image_id='6050_4_4',
#                              n_class=1,
#                              point= (0.005312 , -0.003212),
#                              side=1e-3)
