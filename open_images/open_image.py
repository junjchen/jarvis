...
## Globals
global trainImageIds, gs, df

#this shows the image after plotting something
pyplot.interactive(True)

##passed in show_image
# following boolean determines one image or all
#one_image = True
...
# my local storage of all images

    d = {'3': 'C:/Users/Martin/Documents/Southampton/Advanced Machine Learning/data/three_band/three_band/{}.tif'.format(imageId),
         'A': 'C:/Users/Martin/Documents/Southampton/Advanced Machine Learning/data/three_band/sixteen_band/{}_A.tif'.format(imageId),
         'M': 'C:/Users/Martin/Documents/Southampton/Advanced Machine Learning/data/three_band/sixteen_band/{}_M.tif'.format(imageId),
         'P': 'C:/Users/Martin/Documents/Southampton/Advanced Machine Learning/data/three_band/sixteen_band/{}_P.tif'.format(imageId),
         }
    return d


def get_image_name(imageId):
#just one image, three band, for testing
...
def visualize_image(imageId, plot_all=True):
    ...
    if is_training_image(imageId):
        ...
        for cType in CLASSES.keys():
            print(cType)
            print(df_image[df_image.ClassType == cType].MultipolygonWKT.values[0])
...
def show_image_poly(one_image_id):
    ...
    #show one image
    fig, axArr, ax = visualize_image(one_image_id, plot_all=False)
    plt.savefig('Objects--' + one_image_id + '.png')
    #plt.clf()
